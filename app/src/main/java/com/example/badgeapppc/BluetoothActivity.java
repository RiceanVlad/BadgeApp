...
public class BluetoothActivity extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imgSucces = (ImageView) findViewById(R.id.imageViewSucces);
        imgFail = (ImageView) findViewById(R.id.imageViewFail);
        imgFail.setVisibility(View.INVISIBLE);
        imgSucces.setVisibility(View.INVISIBLE);
    ...
    BroadcastReceiver mReceiver=new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if(text.equals("succes")){
                imgSucces.setVisibility(View.VISIBLE);
                imgFail.setVisibility(View.INVISIBLE);
            } else {
